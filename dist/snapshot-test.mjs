...
var _Color = unwrapExports(Color_1);
...
var _textDecoration = unwrapExports(textDecoration);
...
var _CanvasRenderer = unwrapExports(CanvasRenderer_1);
...
var _Logger = unwrapExports(Logger_1);
...
var _Length = unwrapExports(Length_1);
...
var _Size = unwrapExports(Size_1);
...
var _Vector = unwrapExports(Vector_1);
...
var _BezierCurve = unwrapExports(BezierCurve_1);
...
var _Bounds = unwrapExports(Bounds_1);
...
var _padding = unwrapExports(padding);
...
var calculateBackgroungPositioningArea = exports.calculateBackgroungPositioningArea = function calculateBackgroungPositioningArea(backgroundOrigin, bounds, padding$$1, border) {
    ...
    switch (backgroundOrigin) {
        ...
        case BACKGROUND_ORIGIN.CONTENT_BOX:
            var paddingLeft = padding$$1[_padding.PADDING_SIDES.LEFT].getAbsoluteValue(bounds.width);
            var paddingRight = padding$$1[_padding.PADDING_SIDES.RIGHT].getAbsoluteValue(bounds.width);
            var paddingTop = padding$$1[_padding.PADDING_SIDES.TOP].getAbsoluteValue(bounds.width);
            var paddingBottom = padding$$1[_padding.PADDING_SIDES.BOTTOM].getAbsoluteValue(bounds.width);
...
var _background = unwrapExports(background);
...
var _border = unwrapExports(border);
...
var _borderRadius = unwrapExports(borderRadius);
...
var _display = unwrapExports(display);
...
var _float = unwrapExports(float_1);
...
var _letterSpacing = unwrapExports(letterSpacing);
...
var _lineBreak = unwrapExports(lineBreak);
...
var _listStyle = unwrapExports(listStyle);
...
var _margin = unwrapExports(margin);
...
var _overflow = unwrapExports(overflow);
...
var _overflowWrap = unwrapExports(overflowWrap);
...
var _position = unwrapExports(position);
...
var _textShadow = unwrapExports(textShadow);
...
var _textTransform = unwrapExports(textTransform);
...
var _transform = unwrapExports(transform);
...
var _visibility = unwrapExports(visibility);
...
var _wordBreak = unwrapExports(wordBreak);
...
var _zIndex = unwrapExports(zIndex);
...
var _ForeignObjectRenderer = unwrapExports(ForeignObjectRenderer_1);
...
var _Feature = unwrapExports(Feature);
...
var _Util$1 = unwrapExports(Util$1);
...
var createTrieFromBase64 = exports.createTrieFromBase64 = function createTrieFromBase64(base64) {
    var buffer = (0, _Util$1.decode)(base64);
    var view32 = Array.isArray(buffer) ? (0, _Util$1.polyUint32Array)(buffer) : new Uint32Array(buffer);
    var view16 = Array.isArray(buffer) ? (0, _Util$1.polyUint16Array)(buffer) : new Uint16Array(buffer);
    var headerLength = 24;
...
var _Trie = unwrapExports(Trie_1);
...
var inlineBreakOpportunities = exports.inlineBreakOpportunities = function inlineBreakOpportunities(str, options) {
    var codePoints = (0, _Util$1.toCodePoints)(str);
    ...
    codePoints.forEach(function (codePoint, i) {
        output += (0, _Util$1.fromCodePoint)(codePoint) + (i >= codePoints.length - 1 ? BREAK_MANDATORY : _lineBreakAtIndex(codePoints, classTypes, indicies, i + 1, forbiddenBreakpoints));
    });
...
var Break = function () {
    ...
    _createClass(Break, [{
        ...
        value: function slice() {
            return _Util$1.fromCodePoint.apply(undefined, _toConsumableArray(this._codePoints.slice(this.start, this.end)));
        }
    }]);
...
var cssLineBreak_1_0_1_dist = createCommonjsModule(function (module, exports) {
...
Object.defineProperty(exports, 'toCodePoints', {
  enumerable: true,
  get: function get() {
    return _Util$1.toCodePoints;
  }
});
Object.defineProperty(exports, 'fromCodePoint', {
  enumerable: true,
  get: function get() {
    return _Util$1.fromCodePoint;
  }
});
...
var _cssLineBreak = unwrapExports(cssLineBreak_1_0_1_dist);
...
var _Unicode = unwrapExports(Unicode);
...
var _TextBounds = unwrapExports(TextBounds_1);
...
var _TextContainer = unwrapExports(TextContainer_1);
...
var _Circle = unwrapExports(Circle_1);
...
var _ListItem = unwrapExports(ListItem);
...
var NodeContainer = function () {
    function NodeContainer(node, parent, resourceLoader, index) {
        ...
        var display$$1 = (0, _display.parseDisplay)(style.display);

        var IS_INPUT = node.type === 'radio' || node.type === 'checkbox';

        var position$$1 = (0, _position.parsePosition)(style.position);
        ...
        this.style = {
            ...
            listStyle: display$$1 === _display.DISPLAY.LIST_ITEM ? (0, _listStyle.parseListStyle)(style) : null,
            ...
            zIndex: (0, _zIndex.parseZIndex)(position$$1 !== _position.POSITION.STATIC ? style.zIndex : 'auto')
        };
        ...
        if (display$$1 === _display.DISPLAY.LIST_ITEM) {
...
var _NodeContainer = unwrapExports(NodeContainer_1);
...
var _StackingContext = unwrapExports(StackingContext_1);
...
var _NodeParser = unwrapExports(NodeParser_1);
...
var _Angle = unwrapExports(Angle);
...
var _Gradient = unwrapExports(Gradient);
    ...
    _createClass(Renderer, [{
        ...
        value: function renderNodeBackgroundAndBorders(container) {
            ...
            var hasRenderableBorders = container.style.border.some(function (border$$1) {
                return border$$1.borderStyle !== _border.BORDER_STYLE.NONE && !border$$1.borderColor.isTransparent();
            });
            ...
            var callback = function callback() {
                ...
                container.style.border.forEach(function (border$$1, side) {
                    if (border$$1.borderStyle !== _border.BORDER_STYLE.NONE && !border$$1.borderColor.isTransparent()) {
        ...
        value: function renderBackgroundRepeat(container, background$$1) {
            ...
            if (image) {
                ...
                var backgroundImageSize = (0, _background.calculateBackgroundSize)(background$$1, image, backgroundPositioningArea);
                var position = (0, _background.calculateBackgroundPosition)(background$$1.position, backgroundImageSize, backgroundPositioningArea);
                var _path = (0, _background.calculateBackgroundRepeatPath)(background$$1, position, backgroundImageSize, backgroundPositioningArea, container.bounds);
        ...
        value: function renderBackgroundGradient(container, background$$1) {
            var backgroundPositioningArea = (0, _background.calculateBackgroungPositioningArea)(container.style.background.backgroundOrigin, container.bounds, container.style.padding, container.style.border);
            var backgroundImageSize = (0, _background.calculateGradientBackgroundSize)(background$$1, backgroundPositioningArea);
            var position = (0, _background.calculateBackgroundPosition)(background$$1.position, backgroundImageSize, backgroundPositioningArea);
            var gradientBounds = new _Bounds.Bounds(Math.round(backgroundPositioningArea.left + position.x), Math.round(backgroundPositioningArea.top + position.y), backgroundImageSize.width, backgroundImageSize.height);

            var gradient = (0, _Gradient.parseGradient)(container, background$$1.source, gradientBounds);
            if (gradient) {
        ...
        value: function renderBorder(border$$1, side, curvePoints) {
            this.target.drawShape((0, _Bounds.parsePathForBorder)(curvePoints, side), border$$1.borderColor);
        }
    }, {
        key: 'renderStack',
...
var _Renderer = unwrapExports(Renderer_1);
...
var _Proxy$1 = unwrapExports(_Proxy);
    ...
    _createClass(ResourceLoader, [{
            ...
            if (!isSVG(src) || _Feature2.default.SUPPORT_SVG_DRAWING) {
                if (this.options.allowTaint === true || isInlineImage(src) || this.isSameOrigin(src)) {
                    ...
                    if (typeof this.options.proxy === 'string') {
                        this.cache[src] = (0, _Proxy$1.Proxy)(src, this.options).then(function (src) {
        ...
        value: function inlineImage(src) {
            ...
            if (!this.isSameOrigin(src) && typeof this.options.proxy === 'string') {
                return this.cache[src] = (0, _Proxy$1.Proxy)(src, this.options).then(function (src) {
...
var _ResourceLoader = unwrapExports(ResourceLoader_1);
...
var _PseudoNodeContent = unwrapExports(PseudoNodeContent);
...
var getIframeDocumentElement = function getIframeDocumentElement(node, options) {
    try {
        ...
        return options.proxy ? (0, _Proxy$1.Proxy)(node.src, options).then(function (html) {
...
var _Clone = unwrapExports(Clone);
...
var _Window = unwrapExports(Window);
...
var render = _Window ? _Window.renderElement : Window_1;
...
var detectBrowser_4_2_0_index = createCommonjsModule(function (module, exports) {
...
unwrapExports(detectBrowser_4_2_0_index);
var detectBrowser_4_2_0_index_1 = detectBrowser_4_2_0_index.BrowserInfo;
var detectBrowser_4_2_0_index_2 = detectBrowser_4_2_0_index.NodeInfo;
var detectBrowser_4_2_0_index_3 = detectBrowser_4_2_0_index.BotInfo;
var detectBrowser_4_2_0_index_4 = detectBrowser_4_2_0_index.detect;
var detectBrowser_4_2_0_index_5 = detectBrowser_4_2_0_index.parseUserAgent;
var detectBrowser_4_2_0_index_6 = detectBrowser_4_2_0_index.detectOS;
var detectBrowser_4_2_0_index_7 = detectBrowser_4_2_0_index.getNodeVersion;

var pixelmatch_4_0_2_index = pixelmatch;
...
function getXYChoord(data, index) {
	return [index % (data.width * 4), Math.floor(index / (data.width * 4))];
}
...
function copyTo(canvas, newWidth, newHeight) {
...
function stretchToWidth(canvas, newWidth) {
...
function diff(newImage, oldImage, pixelMatchOptions) {
	...
	var mismatched = pixelmatch_4_0_2_index(newImage.data, oldImage.data, diffOut.data, maxWidth, maxHeight, pixelMatchOptions);
...
function basicDiff(newImage, oldImage) {
	newImage = getImageData(newImage);
	oldImage = getImageData(oldImage);
...
function downloadLink(canvas, title, text) {
...
function diffContent(diffCanvas, newCanvas, oldCanvas, imageName, attempts) {
 ...
 */
function compareToSnapshot(options) {

	var htmlPromise = getCanvasForUrl(options);
	return Promise.all([htmlPromise, findImage(options)]).then(function (results) {
   ...
   var eq = pixelEqual(pixel, [238, 238, 239, 255]);*/
			...
			p.textContent = "There is no snapshot. Download one of the following snapshots by right-clicking " + "the link and selecting 'Save Link As...'. Downloads are ordered by specificity:";
...
function findImage(options) {
	var browser = detectBrowser_4_2_0_index_4();
	var dpr = document.defaultView.devicePixelRatio || 1;
	var dprName = dpr === 1 ? "sd" : dpr === 2 ? "hd" : "dpr" + dpr;

	var attempts = [options.snapshotPrefix + "-" + options.width + "-" + dprName + "-" + browser.name + ".png", options.snapshotPrefix + "-" + options.width + "-" + dprName + ".png", options.snapshotPrefix + "-" + options.width + ".png", options.snapshotPrefix + ".png"];
...
function getCanvasForUrl(options) {
	return new Promise(function (resolve, reject) {
		var div = document.createElement("div");
...
export { getIndex, getXYChoord, ave, getPixel, pixelEqual, resizeCanvas, copyTo, stretchToWidth, dataEqual, diff, basicDiff, downloadLink, diffContent, compareToSnapshot, findImage, getCanvasForUrl, getCanvasForImage };
