# Contributing to bitovi-snapshot-test

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/bitovi/bitovi-snapshot-test) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork bitovi-snapshot-test, you can start by going to its [fork page](https://github.com/bitovi/bitovi-snapshot-test/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/bitovi-snapshot-test
```
